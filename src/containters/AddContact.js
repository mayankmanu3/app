...
export class AddContact extends Component {
  ...
  addContactDetails = (e) => {
    ...
    if (this.state.editForm) {
      ...
      if (contacts !== null) {
        ...
        let id = contacts[contacts.length - 1]
  ...
  editContactDetails = () => {
    ...
    let updatedDate = moment(new Date()).format("DD-MM-YYYY HH:mm:ss");
    let checkEmail = contacts.filter(
  ...
  addContactToLocalStorage = (contacts, type) => {
    ...
    this.callAlert(
      "success",
      "Success",
      `Contact ${type === "add" ? "Added" : "Updated"} Successfully`
    );
...
const FormRow = ({
  ...
  return (
    <div className={"col-md-" + size + " mb-3"}>
      ...
      {invalidEmail ? (
        <div className='invalid-email text-danger small'>
