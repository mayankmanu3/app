  ...
  filterContacts = (contacts) => {
    return contacts.filter(
      (contact) =>
        contact.firstname
          .toLowerCase()
          .indexOf(this.props.searchContact.toLowerCase()) !== -1 ||
        contact.lastname
          .toLowerCase()
          .indexOf(this.props.searchContact.toLowerCase()) !== -1 ||
        (
  ...
  render() {
    ...
    return (
      <div className='row ml-md-4 ml-lg-4 ml-sm-4 pl-md-0'>
                  ...
                  <td className='d-flex flex-row'>
                    ...
                    <div className='ml-2'>
                      {(contact.firstname + " " + contact.lastname).length > 16
                        ? (contact.firstname + " " + contact.lastname).substr(
                            0,
                            16
                          ) + "..."
                  ...
                  <td>
                    <div className='d-flex flex-column flex-md-row'>
                      <div className='d-flex flex-row'>
                        <i
                          className='fa fa-address-card-o action'
                          data-toggle='tooltip'
                          data-placement='top'
                          title='View Contact'
                        ...
                        &nbsp;&nbsp;&nbsp;
                        <i
                          className='fa fa-pencil-square-o action'
                          data-toggle='tooltip'
                          data-placement='top'
                          title='Edit Contact'
                      ...
                      <div className='d-flex flex-row'>
                        <i
                          className='fa fa-trash-o action'
                          data-toggle='tooltip'
                          data-placement='top'
                        ...
                        &nbsp;&nbsp;&nbsp;
                        <i
                          className='fa fa-comments-o action'
                          data-toggle='tooltip'
                          data-placement='top'
                          title='Chat'
        ...
        <div
          className='col-sm-12 col-md-12 col-lg-6 pr-0 pl-2'
          ref={(ref) => (this.details = ref)}
        >
          {Object.keys(user).length > 0 && !chatEnabled && (
          ...
          {chatEnabled && (
            <div
              className='ml-lg-5 col-md-12 bg-lightgray p-0'
...
const DetailsRow = (props) => {
  return (
    <div>
      <div
        className={props.lastrow ? "d-flex flex-row pb-3" : "d-flex flex-row"}
      >
